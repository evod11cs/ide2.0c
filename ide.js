class Editor{
    ...
    setupAll(){
      ...
      this.textBar.id = "textBar" + this.pos
      ...
      document.body.appendChild(this.textBar)
...
#textBar${this.pos}{
  width:${this.width + this.numbersWidth}px;
  height: ${this.lineHeight}px !important;
  position:absolute;
  background-color:rgba(68,60,51,0.3);
  z-index:-1;
}
...
.active{
    ...
    createLineNumber(){
        ...
        let newLine = ""
        this.textBar.style.top = (((this.locateCursor()[1]) * this.lineHeight) + 30) + "px"
        this.textBar.style.left = this.x
        lineElt[0].innerHTML = ""
